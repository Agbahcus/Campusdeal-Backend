...
urlpatterns = [
    # Feed (home screen)
    path('feed/', feed_views.home_feed, name='home-feed'),
    ...
    path('listings/<int:listing_id>/offer/', offer_views.send_offer, name='send-offer'),
    path('listings/<int:listing_id>/offers/', offer_views.listing_offers, name='listing-offers'),

    # Offers
    path('offers/', offer_views.list_offers, name='list-offers'),
    path('offers/<int:offer_id>/respond/', offer_views.respond_to_offer, name='respond-to-offer'),
